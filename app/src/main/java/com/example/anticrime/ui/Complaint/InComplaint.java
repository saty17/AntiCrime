package com.example.anticrime.ui.Complaint;
...
import com.example.anticrime.ComplaintAdapter;
...
public class InComplaint extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_in_complaint, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=view.findViewById(R.id.incomplaintrecycle);
