package com.example.anticrime.ui.MissingPerson;
...
import com.example.anticrime.MissingAdapter;
...
public class InMissing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_in_missing, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=view.findViewById(R.id.inmissingrecycle);
